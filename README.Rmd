...
Launch the [`make.R`](https://github.com/brainworkup/compendium/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/brainworkup/compendium/blob/main/CONTRIBUTING.md).
